...
## Updated Idea Files
- `Idea_DataBase/Code_Guide_v1.py` (2026-03-15 23:37:37 KST)
  - 목적 요약: You are helping build research code for unsupervised heart sound cycle analysis입니다.
- `Idea_DataBase/Processed_Idea.py` (2026-03-15 23:37:37 KST)
...
- `Idea_DataBase/Train_Idea.py` (2026-03-15 23:37:37 KST)
...
- `Idea_DataBase/Embedded_Idea.py` (2026-03-15 23:37:37 KST)
...
- `Idea_DataBase/Result_Idea.py` (2026-03-15 23:37:37 KST)
...
- `Idea_DataBase/Code_Guide_v2.py` (2026-03-15 23:37:37 KST)
  - 목적 요약: 현재 프로젝트의 비지도학습 파이프라인(전처리 → autoencoder 학습 → embedding 추출 및 HDBSCAN → cluster 해석)을 수정하고 싶습니다입니다.
- `Idea_DataBase/Code_Total_Result_Idea.py` (2026-03-15 23:37:37 KST)
